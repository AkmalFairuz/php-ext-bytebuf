...
if test "$PHP_BYTEBUF" != "no"; then
  ...
  PHP_NEW_EXTENSION(bytebuf, bytebuf.cpp lib/ByteBuf.cpp lib/ByteFlipper.cpp lib/VarInt.cpp src/PhpByteBuf.cpp src/PhpBigEndian.cpp src/PhpLittleEndian.cpp src/Int24Util.cpp src/VarInt.cpp, $ext_shared,,-std=c++17 -Wall -Werror, yes)
